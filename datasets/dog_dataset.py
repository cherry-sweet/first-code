...
DATAPATH = '/media/data/zpp/code/wsdan/DATA/StanfordDogs'
...
class DogDataset(Dataset):
    ...
    def __init__(self, phase='train', resize=500):
        ...
        self.images = [f.item().item() for f in list_mat['file_list']]  # 获得样本的名称  list:12000
        self.labels = [f.item() for f in list_mat['labels']]  # 获得样本标签 list:12000
